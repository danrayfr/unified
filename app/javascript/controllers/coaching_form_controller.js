            ...
            <div>
              ...
              <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 px-6 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                ...
                <div class="sm:col-span-3 mt-3">
                  <label class="text-gray-600 mb-3">Session name</label>
                ...
                <div class="col-span-full">
                  ...
                  <textarea class="w-full rounded-lg border-gray-200 p-3 text-sm" rows="8" id="message" name="custom_content[]">${custom.content}</textarea>
                </div>   
              </div>
            </div>
          </div>
